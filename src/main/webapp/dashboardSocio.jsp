...
<body class="bg-dark text-white">
    ...
    <main class="container py-5 mt-4" style="max-width: 500px;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 style="font-family: 'Anton', sans-serif; letter-spacing: 1px;">Hola, <span class="text-warning">Oliver</span> <i class="fa-solid fa-hand-fist text-warning"></i></h2>
        ...
        <div class="d-flex flex-column gap-3 mb-5">
            <a href="gimnasios.jsp" class="btn btn-outline-secondary text-start py-3 px-4 text-white custom-btn-action">
                <i class="fa-solid fa-location-dot text-warning me-3"></i> Ver sedes
            </a>
            <a href="reservarClase.jsp" class="btn btn-outline-secondary text-start py-3 px-4 text-white custom-btn-action">
                <i class="fa-regular fa-calendar-plus text-warning me-3"></i> Reservar clase
            </a>
            <a href="misReservas.jsp" class="btn btn-outline-secondary text-start py-3 px-4 text-white custom-btn-action">
